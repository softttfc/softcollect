# 由 icon-source.jpg 生成 icon.png (256x256) 与多尺寸 icon.ico
...
function Save-ResizedPng($img, $size, $outPath) {
...
foreach ($s in $sizes) { Save-ResizedPng $square $s (Join-Path $tmpDir "$s.png") }
$square.Dispose()
