...
function ensureMusicTempo() {
  ...
  musicTempoLoadPromise = fetch((typeof location !== 'undefined' ? new URL('vendor/music-tempo.min.js', location.href).href : 'vendor/music-tempo.min.js'))
    .then(function (resp) {
...
function getMusicTempoWorkerUrl() {
  ...
  var code = [
    ...
    'var d=e.data||{};',
    'try{',
    'importScripts(d.scriptUrl||new URL("vendor/music-tempo.min.js", location.href).href);',
